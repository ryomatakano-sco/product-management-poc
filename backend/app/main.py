...
# --- Daily notification scheduler (services/scheduler.py, review C3) -----------
# Runs in-process on the lifespan context. SINGLE-WORKER assumption — see the
# module docstring in services/scheduler.py. ENABLE_SCHEDULER=0 disables it
# (multi-worker deploys must enable it on exactly one process).
